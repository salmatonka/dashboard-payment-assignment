...
const Footer = () => {
  return (
    <footer className="px-4 divide-y text-white bg-[#1D59A0] dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <img alt="" className="w-12 h-12 mr-2 border rounded-full dark:bg-gray-500 dark:border-gray-700" src="https://previews.123rf.com/images/butenkow/butenkow1701/butenkow170102106/70227809-wedding-photographer-vector-illustration-of-icon.jpg" />Wedding House
        </Link>
		</div>
